...
class devoluciones {
    ...
    selectFolioCliente(id){
            ...
            return this.knex.from("dev_tbl_folio").select("*").leftJoin('dev_tbl_motivo_devolucion', 'dev_tbl_folio.Motivo_devolucion', 'dev_tbl_motivo_devolucion.id_motivo').leftJoin('dev_tbl_estado_folio', 'dev_tbl_estado_folio.id', 'dev_tbl_folio.estado_folio').where('rut_cliente',id);
